...
# TODO:- Make 'Toplevel Message' for After Login Employee Window.
...
def emp_search_profile():
    ...
    with open('Files/#usernames.csv','r') as a:
        ...
        if rownum == 1:
            ...
            tabview3_label_money_info.configure(text=user_money_emp)
        else:
            pass
...
def after_login_window_emp():
    ...
    # label_1 : HEADING
    # label_1 = CTkLabel(master=root4,text='Your Profile',font=('Roboto',25,'underline'))
    # label_1.grid(row=1,column=1,pady=10,padx=60,ipadx=20,columnspan=2,)
    ...
    frame4_button1 = CTkButton(master=frame4,text='Main',width=169,height=80,border_color='#3f60fc',
        hover_color='#35dd17',border_width=3,font=('Roboto',15,),command=main)
    frame4_button1.grid(row=0,column=0,pady=(10,5),padx=(5,5))
    frame4_button2 = CTkButton(master=frame4,text='Back',width=169,height=80,border_color='#3f60fc',
        hover_color='#f4680b',border_width=3,font=('Roboto',15,),command=second_window)
    frame4_button2.grid(row=1,column=0,pady=(0,5),padx=(5,5))
    frame4_button3 = CTkButton(master=frame4,text='Exit',width=169,height=80,border_color='#3f60fc',
        hover_color='#f8182f',border_width=3,font=('Roboto',15,),command=root4.destroy)
    ...
    tabview3_label_user_info = CTkLabel(master=tabview_3.tab('Search'),text=" ",font=('Courier New',22,))
    ...
    tabview3_label_money_info.grid(row=2,column=2,pady=(0,10),padx=(20,0),sticky='wn')
    ...
    frame4_2_button1 = CTkButton(master=frame4_2,text="Search",width=80,height=50,
        border_color='#3f60fc',state='disabled',border_width=3,command=emp_search_profile)
